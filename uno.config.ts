...
export default defineConfig({
  ...
  theme: {
    ...
    fontFamily: {
      title: ['Lato', 'EarlySummer-Subset', 'EarlySummer', 'ui-serif', 'Georgia', 'Cambria', 'Times New Roman', 'Times', 'serif'],
      navbar: ['EB Garamond', 'STIX-Italic', 'serif'],
      time: ['EB Garamond', 'Georgia', 'Times New Roman', 'Times', 'serif'],
